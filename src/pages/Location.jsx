export default function Location() {
  return (
    <section>
      ...
      <div className='flex flex-col flex-wrap items-center w-full m-5'>
        ...
        <div className='flex flex-col w-1/2'>
          <h3>Address</h3>
          <p>31516 Railroad Canyon Rd, Canyon Lake, CA 92587</p>
          <h3>Hours</h3>
          <p>Sundays</p>
          <p>9:00am - 1:00pm</p>
        </div>
      ...
      <div className='flex flex-col items-center w-full m-5'>
        ...
        <div className='w-1/2'>
          <h3>Address</h3>
          <p>26850 Sun City Blvd Sun City, CA 92586</p>
          <h3>Hours</h3>
          <p>Saturdays</p>
          <p>8:00am - 12:00pm</p>
        </div>
